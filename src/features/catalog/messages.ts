...
export const catalogMessages = {
  ...
  items: {
    ...
    form: {
      ...
      costHint: 'Opcional · sirve para calcular el margen.',
      marginLabelPrefix: 'Margen:',
      marginBelowCost: 'Precio por debajo del costo',
      marginThin: 'Margen bajo',
      ...
      errors: {
        ...
        costInvalid: 'El costo debe ser un número mayor o igual a 0.',
      },
    },
    createDialog: {
